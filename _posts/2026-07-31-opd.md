...
笔者最近在做 MOPD 研究时发现，在计算 Advantage（教师-学生预测概率的 log-ratio）时，仅对学生采样的单个 token 计算已经效果很好。Kimi K3 技术报告中也消融了 top-k 枚举，同样未见性能或效率提升。有感而发，本文从理论角度严格讨论：**在 On-Policy Distillation 中，为什么不能对全词表计算多步 Advantage**。
